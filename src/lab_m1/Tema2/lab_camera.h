...
namespace cameraTema2
{
    class Camera
    {
     public:
        ...
        void MoveForward(float distance,glm::vec3 forwardtank)
        {
        ...
        glm::mat4 GetViewMatrixOrto(tank::tank *tank)
        {

            glm::vec3 cameraPosition = glm::vec3(tank->position.x, tank->position.y + 9.0f, tank->position.z);
            glm::vec3 targetPosition = glm::vec3(tank->position.x, tank->position.y, tank->position.z);
