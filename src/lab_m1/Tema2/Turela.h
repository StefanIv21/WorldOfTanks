...
namespace cameraTema2
{
    class Turela
    {
     public:
        ...
        Turela(const glm::vec3 &position, const glm::vec3 &orward, const glm::vec3 &up, const glm::vec3 &right)
        {
            Set(position, forward, up, right);
        }
        ...
        // Update camera
        void Set(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up,const glm::vec3 &right)
        {
